...
import rblstudios.com.cadastroproduto.CadastroMarcaPagerAdapter;
...
public class CadastroMarca extends AppCompatActivity implements FragmentoCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdaptadorPager = new CadastroMarcaPagerAdapter(getSupportFragmentManager(), this);
